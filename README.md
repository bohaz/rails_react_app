...
This is an exersice to connect the back-end with the front-end allowing to refresh React and Ruby on rails knowledge.
...
```sh
  cd my-folder
  git clone git@github.com:bohaz/rails_react_app.git
```
...
Feel free to check the [issues page](https://github.com/bohaz/rails_react_app/issues).
...
This project is [MIT](https://github.com/bohaz/rails_react_app/blob/rails-react/MIT.md) licensed.
